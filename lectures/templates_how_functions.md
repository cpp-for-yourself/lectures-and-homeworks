...
This topic is quite confusing because of the complicated rules of [template argument deduction](https://en.cppreference.com/w/cpp/language/template_argument_deduction). The best thing I can do is give a couple of examples that look a little counterintuitive to me (and to [many other people](https://stackoverflow.com/questions/25353976/why-do-templates-not-implicitly-instantiate-to-const-or-reference-types) for that matter).
